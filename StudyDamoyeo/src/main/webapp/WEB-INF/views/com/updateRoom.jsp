        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">내 지점</a></li>
              <li class="breadcrumb-item active">지점 수정</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form role="form" method="post" enctype="multipart/form-data"
                ...
                <div class="card-body">
                 <div class="form-group">
                 	<input type="hidden" value="${room.rno }" name="rno">
                    <label for="roomname">지점 이름</label>
                    <input type="text" class="form-control col-sm-4" value="${room.roomname }" id="roomname" name="roomname" placeholder="지점명(지역명)">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputFile1" value="${room.imgname1 }" name="img1" onchange="showFile(1);">
                        <label class="custom-file-label" for="exampleInputFile" id="fileLabel1">사진1</label>

                      </div>
                   		&nbsp;
                      <div class="custom-file">
						<input type="file" class="custom-file-input" id="inputFile2" value="${room.imgname2 }" name="img2" onchange="showFile(2);">
                        <label class="custom-file-label" for="exampleInputFile" id="fileLabel2">사진2</label>
                      </div>
                   
                   		 &nbsp;
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputFile3" value="${room.imgname3 }" name="img3" onchange="showFile(3);">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="presentation1" value="${room.presentation1 }" name="presentation1" placeholder="위 사진들의 소개글을 입력해주세요.">
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="presentation2" value="${room.presentation2 }" name="presentation2" placeholder="위 사진의 소개글을 입력해주세요.">
                  </div>
                      <!-- textarea -->
                  <div class="form-group">
                    <label>소개글 3</label>
                    <textarea class="form-control" id="presentation3" value="${room.presentation3 }" name="presentation3" rows="4" placeholder="간단한 지점 소개글을 작성해주세요.(가격, 시설 등)"></textarea>
               	  ...
               	  <div class="form-group">
                 	 ...
                 	 <div class="input-group">
						<input class="form-control col-sm-2" type="text" id="No" name="location1" style="width:30%" value="${room.location1 }">
						<input class="btn btn-primary" type="button"  value="주소검색" onclick="goPopup();">
               	 	 </div>
              	  </div>
              		 <div class="form-group">
                	 <label for="loacation2">상세 주소</label><br>
                		<input  class="form-control col-sm-4"type="text" id="AddrPart1"  name="location2"  style="width:85%" value="${room.location2 }">
                		 <div class="input-group">
                			<input  class="form-control col-sm-6"type="text" id="Detail"  name="location3"   style="width:30%" value="${room.location3 }">
                			<input  class="form-control col-sm-6"type="text" id="AddrPart2"  name="location4"  style="width:30%" value="${room.location4 }">
                		</div>
                	</div>
                </div>
                <!-- /.card-body -->

              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="/resources/com/dist/img/user4-128x128.jpg"
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>회원구분</b> <a class="float-right">기업회원</a>
                  </li>
                 <!--  <li class="list-group-item">
                ...
                <a href="#" class="btn btn-primary btn-block"><b>프로필 이미지 등록</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/resources/com/dist/img/user1-128x128.jpg" alt="user image">
                        <span class="username">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/resources/com/dist/img/user7-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="float-right btn-tool"><i class="fa fa-times"></i></a>
                        </span>
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="/resources/com/dist/img/user6-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fa fa-times"></i></a>
                        </span>
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="/resources/com/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="/resources/com/dist/img/photo2.png" alt="Photo">
                              <img class="img-fluid" src="/resources/com/dist/img/photo3.jpg" alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="/resources/com/dist/img/photo4.jpg" alt="Photo">
                              <img class="img-fluid" src="/resources/com/dist/img/photo1.png" alt="Photo">
                            </div>
                            <!-- /.col -->
                          </div>

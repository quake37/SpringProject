...
<% 
	...
	String AddrPart1 = request.getParameter("roadAddrPart1"); 
	String AddrPart2 = request.getParameter("roadAddrPart2"); 
...
function init(){
	...
	if(inputYn != "Y"){
		...
		opener.jusoCallBack("<%=AddrPart1%>","<%=addrDetail%>", "<%=AddrPart2%>","<%=zipNo%>");
		window.close();
